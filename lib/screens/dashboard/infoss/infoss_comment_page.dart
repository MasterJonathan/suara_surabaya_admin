...
class _InfossCommentPageState extends State<InfossCommentPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<InfossProvider>().loadInitialComments();
    });
  }
  ...
  Widget _buildTableControls(InfossProvider provider) {
    return Row(
  ...
  Widget _buildDataTable(InfossProvider provider) {
    ...
    final List<InfossCommentModel> sortedData = List.from(provider.comments);
                    ...
                    Row(
                      children: [
                        _actionButton(
                          ...
                          tooltip: isDeleted ? 'Pulihkan' : 'Hapus',
