// lib/screens/dashboard/infoss/infoss_comment_page.dart
...
class InfossCommentPage extends StatefulWidget {
  const InfossCommentPage({super.key});

  @override
  State<InfossCommentPage> createState() => _InfossCommentPageState();
}

class _InfossCommentPageState extends State<InfossCommentPage> {
  ...
  Widget build(BuildContext context) {
    return Consumer<InfossProvider>(
      builder: (context, provider, child) {
        ...
        return Column(
          key: const PageStorageKey('infossCommentPage'),
              ...
              child: SingleChildScrollView(
                ...
                child: CustomCard(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Manajemen Komentar Info SS", style: Theme.of(context).textTheme.titleLarge),
                      const SizedBox(height: 20),
                      _buildTableControls(),
                      const SizedBox(height: 20),
                      
                      if (provider.state == InfossViewState.Busy && provider.comments.isEmpty)
  ...
  Widget _buildDataTable(InfossProvider provider, List<InfossCommentModel> dataToShow) {
    return DataTable(
